...
public class ProblemATests
{
    ...
    {
        var subscriptionActive = ProblemA.GetActiveSubscriptionsDuringYearAndMonth(Addresses.All, 2021, 1);
    ...
    {
        var subscriptionActive = ProblemA.GetActiveSubscriptionsDuringYearAndMonth(Addresses.All, 2021, 10);
    ...
    {
        var subscriptionActive = ProblemA.GetActiveSubscriptionsDuringYearAndMonth(Addresses.All, 2021, 12);
