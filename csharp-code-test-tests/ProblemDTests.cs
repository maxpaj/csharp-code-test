...
public class ProblemDTests
{
    ...
    {
        var subscriptionsActiveInOctober = ProblemD.GetAddressesWithFutureSubscriptionActivations(Addresses.All, 2021, 10);
    ...
    {
        var subscriptionsActiveInDecember = ProblemD.GetAddressesWithFutureSubscriptionActivations(Addresses.All, 2021, 12);
